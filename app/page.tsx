...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.05] pointer-events-none z-0 select-none">
      ...
      <header className="container mx-auto px-4 py-6 relative z-10">
        <nav className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            <Link href="/" className="hover:text-orange-400 border-b-2 border-orange-400 text-orange-400">
              Home
            </Link>
            <Link href="#about" className="hover:text-orange-400 text-gray-300">
              About
            </Link>
            <Link href="#education" className="hover:text-orange-400 text-gray-300">
              Education
            </Link>
            <Link href="#experience" className="hover:text-orange-400 text-gray-300">
              Experience
            </Link>
            <Link href="#skills" className="hover:text-orange-400 text-gray-300">
              Skills
            </Link>
            <Link href="#projects" className="hover:text-orange-400 text-gray-300">
              Projects
            </Link>
            <button
              onClick={toggleTheme}
              className="p-2 rounded-full hover:bg-gray-700 text-gray-300 hover:text-orange-400"
      ...
      <main className="container mx-auto px-4 py-12 relative z-10">
        <div className="flex flex-col md:flex-row items-start justify-between">
          ...
          <div className="w-full md:w-1/2 mb-12 md:mb-0">
            ...
            <div className="flex space-x-4">
              <Link href="#experience">
                <Button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-md flex items-center space-x-2 shadow-lg">
              ...
              <Link href="#about">
                <Button
                  variant="outline"
                  className="border-orange-400 text-orange-400 hover:bg-orange-400 hover:text-gray-900 px-6 py-2 rounded-md transition-all duration-300"
                >
                  About Me
                </Button>
              </Link>
          ...
          <div className="w-full md:w-2/5 bg-gray-800 border border-gray-700 rounded-lg p-6 shadow-xl">
            <h3 className="text-orange-400 font-mono mb-4">// get-in-touch</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="tel:+6281234113911" className="text-orange-400 hover:text-orange-300 hover:underline">
                    +62 81234113911
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <Github className="text-purple-400 mt-1" size={18} />
                <div>
        ...
        <section id="education" className="py-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4 text-gray-100">Education</h2>
          </div>
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-xl">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
              <div>
                <h3 className="text-xl font-bold text-gray-100">Telkom University</h3>
                <p className="text-gray-400">Bachelor's Degree in Informatics</p>
              </div>
              <div className="mt-2 md:mt-0">
                <p className="text-orange-400 font-medium">Aug 2019 - Sep 2023</p>
                <p className="text-gray-400">GPA: 3.67/4.00</p>
              </div>
            </div>
            <div className="mt-4">
              <h4 className="font-medium mb-2 text-gray-200">Activities & Memberships:</h4>
        ...
        <section id="experience" className="py-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4 text-gray-100">Experience</h2>
          </div>

          {/* Experience 1 */}
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-xl mb-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
              <div>
                <h3 className="text-xl font-bold text-gray-100">Elbond Education Organizer</h3>
                <p className="text-gray-400">Videographer & Photographer – Freelance</p>
              </div>
              <div className="mt-2 md:mt-0">
                <p className="text-orange-400 font-medium">Jul 2024 - Feb 2025 (Present)</p>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-xl mb-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
              <div>
                <h3 className="text-xl font-bold text-gray-100">Aesthetic Studio Event Documentation</h3>
                <p className="text-gray-400">Videographer & Photographer – Freelance</p>
              </div>
              <div className="mt-2 md:mt-0">
                <p className="text-orange-400 font-medium">May 2024 - Feb 2025 (Present)</p>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-xl mb-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
              <div>
                <h3 className="text-xl font-bold text-gray-100">PT. Nutrifood Indonesia – Telkom University</h3>
                <p className="text-gray-400">Research Assistant – Intern</p>
              </div>
              <div className="mt-2 md:mt-0">
                <p className="text-orange-400 font-medium">Jul 2022 - Sep 2022</p>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-xl">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
              <div>
                <h3 className="text-xl font-bold text-gray-100">Balitbang SDM Kementerian Kominfo</h3>
                <p className="text-gray-400">Independent Study. Network Programmability (MSIB)</p>
              </div>
              <div className="mt-2 md:mt-0">
                <p className="text-orange-400 font-medium">Feb 2022 - Jul 2022</p>
        ...
        <section id="certifications" className="py-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4 text-gray-100">Certifications</h2>
          </div>
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-xl">
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-200">Test of English as a Foreign Language (TOEFL)</p>
                  <p className="text-gray-400">By English Vit (Score 577), 2024</p>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                <Award className="text-yellow-400 mt-1 flex-shrink-0" size={20} />
                <div>
                  <p className="font-medium text-gray-200">Microsoft Azure Data Fundamentals</p>
                  <p className="text-gray-400">by Microsoft And Mereka, 2023</p>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                <Award className="text-yellow-400 mt-1 flex-shrink-0" size={20} />
                <div>
                  <p className="font-medium text-gray-200">Microsoft Power BI Data Analyst</p>
                  <p className="text-gray-400">by Microsoft And Mereka, 2023</p>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                <Award className="text-yellow-400 mt-1 flex-shrink-0" size={20} />
                <div>
                  <p className="font-medium text-gray-200">Cisco Certified Network Associate</p>
        ...
        <section id="skills" className="py-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4 text-gray-100">Skills</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-xl">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-100">Hard Skills</h3>
              </div>
              <div className="space-y-4">
                <div>
                  <p className="font-medium mb-2 text-gray-200">Videography & Photography</p>
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div className="bg-orange-500 h-2.5 rounded-full" style={{ width: "95%" }}></div>
                  </div>
                </div>
                <div>
                  <p className="font-medium mb-2 text-gray-200">Editing</p>
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div className="bg-orange-500 h-2.5 rounded-full" style={{ width: "90%" }}></div>
                  </div>
                </div>
                <div>
                  <p className="font-medium mb-2 text-gray-200">Programming (Python)</p>
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-xl">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-100">Software</h3>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-700 border border-gray-600 p-3 rounded-md text-center">
                  <p className="text-gray-200">Premiere</p>
                </div>
                <div className="bg-gray-700 border border-gray-600 p-3 rounded-md text-center">
                  <p className="text-gray-200">After Effect</p>
                </div>
                <div className="bg-gray-700 border border-gray-600 p-3 rounded-md text-center">
                  <p className="text-gray-200">Filmora</p>
                </div>
                <div className="bg-gray-700 border border-gray-600 p-3 rounded-md text-center">
                  <p className="text-gray-200">Capcut</p>
                </div>
                <div className="bg-gray-700 border border-gray-600 p-3 rounded-md text-center">
                  <p className="text-gray-200">Microsoft</p>
                </div>
                <div className="bg-gray-700 border border-gray-600 p-3 rounded-md text-center">
                  <p className="text-gray-200">VS Code</p>
                </div>
                <div className="bg-gray-700 border border-gray-600 p-3 rounded-md text-center">
                  <p className="text-gray-200">R Studio</p>
                </div>
                <div className="bg-gray-700 border border-gray-600 p-3 rounded-md text-center">
                  <p className="text-gray-200">Power BI</p>
                </div>
              </div>
            </div>
        ...
        <section id="projects" className="py-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4 text-gray-100">Featured Projects</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">Some of my recent work and personal projects</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Project 1 */}
            <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2 text-gray-100">COVID-19 Dashboard</h3>
                <p className="text-gray-400 mb-4">
                  Interactive dashboard for visualizing COVID-19 data with various filters and charts.
                </p>
                <div className="flex space-x-2 text-sm">
                  <span className="bg-gray-700 border border-gray-600 px-2 py-1 rounded text-gray-300">Python</span>
                  <span className="bg-gray-700 border border-gray-600 px-2 py-1 rounded text-gray-300">Data Viz</span>
                </div>
                <div className="mt-4">
                  <a
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2 text-gray-100">Smart Contract App</h3>
                <p className="text-gray-400 mb-4">
                  Simple application for blockchain smart contracts with web interface.
                </p>
                <div className="flex space-x-2 text-sm">
                  <span className="bg-gray-700 border border-gray-600 px-2 py-1 rounded text-gray-300">JavaScript</span>
                  <span className="bg-gray-700 border border-gray-600 px-2 py-1 rounded text-gray-300">Blockchain</span>
                </div>
                <div className="mt-4">
                  <a
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2 text-gray-100">Fuzzy Logic Implementation</h3>
                <p className="text-gray-400 mb-4">
                  Implementation of fuzzy logic algorithms for decision-making systems.
                </p>
                <div className="flex space-x-2 text-sm">
                  <span className="bg-gray-700 border border-gray-600 px-2 py-1 rounded text-gray-300">Python</span>
                  <span className="bg-gray-700 border border-gray-600 px-2 py-1 rounded text-gray-300">AI</span>
                </div>
                <div className="mt-4">
                  <a
